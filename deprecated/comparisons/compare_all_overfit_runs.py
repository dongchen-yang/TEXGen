"""Compare all overfit runs: Vanilla, GT Mask Cond, and Mask Cls lambda sweep (0.01, 0.1, 1.0, 10.0)."""
...
RUNS = {
    ...
    "Mask Cls λ=0.01": "../outputs/overfit_mask_cls_lambda001/lightgen/pointuv_overfit_mask_cls_lambda001/tb_logs/version_0",
    "Mask Cls λ=0.1":  "../outputs/overfit_mask_cls_lambda01/lightgen/pointuv_overfit_mask_cls_lambda01/tb_logs/version_0",
    "Mask Cls λ=1.0":  "../outputs/overfit_mask_cls/lightgen/pointuv_overfit_mask_cls/tb_logs/version_0",
    "Mask Cls λ=10.0": "../outputs/overfit_mask_cls_lambda10/lightgen/pointuv_overfit_mask_cls_lambda10/tb_logs/version_0",
}
...
SAVE_DIRS = {
    ...
    "Mask Cls λ=0.01": "../outputs/overfit_mask_cls_lambda001/lightgen/pointuv_overfit_mask_cls_lambda001/save",
    "Mask Cls λ=0.1":  "../outputs/overfit_mask_cls_lambda01/lightgen/pointuv_overfit_mask_cls_lambda01/save",
    "Mask Cls λ=1.0":  "../outputs/overfit_mask_cls/lightgen/pointuv_overfit_mask_cls/save",
    "Mask Cls λ=10.0": "../outputs/overfit_mask_cls_lambda10/lightgen/pointuv_overfit_mask_cls_lambda10/save",
}

COLORS = {
    "Vanilla":          "#1f77b4",
    "GT Mask Cond":     "#ff7f0e",
    "Mask Cls λ=0.01":  "#2ca02c",
    "Mask Cls λ=0.1":   "#9467bd",
    "Mask Cls λ=1.0":   "#d62728",
    "Mask Cls λ=10.0":  "#8c564b",
}

OUT_DIR = "comparison_all_overfit"
...
def plot_training_curves(data):
    """Plot val/psnr and val/mse curves for all runs."""
...
def print_metrics_table(data):
    ...
    print("\n" + "=" * 80)
    print(f"  {'Variant':<20} | {'Best PSNR':>10} @ {'Step':>6} | {'Final PSNR':>11} | {'Best MSE':>10} | {'Final MSE':>10}")
    print("  " + "-" * 76)
    for name in RUNS:
        ...
        print(
            f"  {name:<20} | {vals_p[best_psnr_idx]:>8.2f}dB @ {steps_p[best_psnr_idx]:>5} | "
...
def create_visual_comparison():
    ...
    fig.suptitle("Composite — All Overfit Runs", fontsize=15, fontweight="bold", y=1.0)
...
def convergence_analysis(data):
    ...
    for name in RUNS:
        ...
        print(f"  {name:<20} | Best PSNR: {best_psnr:.2f}dB | 90% threshold: {threshold_90:.2f}dB | Reached at step: {step_90}")
