#!/bin/bash
# Launch mask_cls_lambda001 training on fir cluster
# Config: lightgen_pointuv_256_batch32_emission_filtered_mask_cls_lambda001.yaml

CONFIG="configs/lightgen_pointuv_256_batch32_emission_filtered_mask_cls_lambda001.yaml"
NAME="e_cls_lambda001"
