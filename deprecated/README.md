...
| top level | `simple_uv_unet.py` (an early plain UV U-Net, never trained for a published number), `main.py` + `pyproject.toml` (a `uv init` stub), `LIGHTGEN_WORKFLOW.md` and `CLAUDE_2026-09-07.md` (the old docs; their live content is in `../TEXGEN_EMISSION.md`, the 2026-03/04 experiment log stays in `CLAUDE_2026-09-07.md`) | |
