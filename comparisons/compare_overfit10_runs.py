"""Compare 10-sample overfit runs: Vanilla, GT Mask Cond, and Mask Cls λ=0.01."""
...
# ── Config ──────────────────────────────────────────────────────────────────
RUNS = {
    "Vanilla":          "../outputs/overfit10_vanilla/lightgen/pointuv_overfit10_vanilla/tb_logs/version_1",
    "GT Mask Cond":     "../outputs/overfit10_gt_mask_cond/lightgen/pointuv_overfit10_gt_mask_cond/tb_logs/version_1",
    "Mask Cls λ=0.01":  "../outputs/overfit10_mask_cls_lambda001/lightgen/pointuv_overfit10_mask_cls_lambda001/tb_logs/version_1",
}

SAVE_DIRS = {
    "Vanilla":          "../outputs/overfit10_vanilla/lightgen/pointuv_overfit10_vanilla/save",
    "GT Mask Cond":     "../outputs/overfit10_gt_mask_cond/lightgen/pointuv_overfit10_gt_mask_cond/save",
    "Mask Cls λ=0.01":  "../outputs/overfit10_mask_cls_lambda001/lightgen/pointuv_overfit10_mask_cls_lambda001/save",
}
...
def plot_training_curves(data):
    ...
    ax.set_title("Validation PSNR — 10-Sample Overfit")
    ...
    ax.set_xlabel("Step")
    ax.set_ylabel("MSE")
    ax.set_title("Validation MSE — 10-Sample Overfit")
    ax.legend(fontsize=9)
    ax.grid(True, alpha=0.3)
    ax.set_yscale("log")
...
def create_visual_comparison():
    ...
    Shows sample 0 (composite_0_0_0.jpg) for each."""
    ...
    fig.suptitle("Composite — 10-Sample Overfit Runs", fontsize=15, fontweight="bold", y=1.0)
