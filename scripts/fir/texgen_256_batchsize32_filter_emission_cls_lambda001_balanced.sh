#!/bin/bash
# Launch mask_cls_lambda001_balanced training on fir cluster
# Config: lightgen_pointuv_256_batch32_emission_filtered_mask_cls_lambda001_balanced.yaml

CONFIG="configs/lightgen_pointuv_256_batch32_emission_filtered_mask_cls_lambda001_balanced.yaml"
NAME="e_cls_l001_bal"
