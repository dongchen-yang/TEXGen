#!/bin/bash
# Launch gt_mask_condition training on fir cluster
# Config: lightgen_pointuv_256_batch32_emission_filtered_gt_mask_cond.yaml

CONFIG="configs/lightgen_pointuv_256_batch32_emission_filtered_gt_mask_cond.yaml"
NAME="e_gt_mask"
